...
{
    public static async Task<Pagination<R>> ToPagination<T, R>(this IQueryable<T> items, int pageNumber, int pageSize, string orderBy, bool descending, Func<T, R> selector)
    {
